      ...
      <main className="responsive-container" style={{
        ...
        <div className="responsive-hero" style={{
          ...
          <h1 style={{
            ...
            Validate Your Landing Page<br />
            <span style={{ color: '#2563eb' }}>For Google Ads Compliance</span>
          </h1>
          <p style={{
            fontSize: '20px',
            color: '#4b5563',
            ...
            Scan your landing page instantly and get detailed report with AI-powered analysis.
            Avoid disapproval and ensure your ads run smoothly!
          </p>
        ...
        <div className="responsive-statistics" style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              Google Ads Requirements Checked
            </div>
          </div>
          <div style={{
            textAlign: 'center',
        ...
        <div className="responsive-section" style={{
          ...
          <p style={{
            ...
            Comprehensive analysis based on Google Ads Landing Page requirements
          </p>
          ...
          <div className="responsive-grid-2" style={{
            ...
            <div style={{
              ...
              <ul style={{
                ...
                <li>No third-party redirects</li>
                <li>URL consistency check</li>
            ...
            <div style={{
              ...
              <ul style={{
                ...
                <li>Unique content detection</li>
                <li>AI-powered duplicate check</li>
                <li>Content quality assessment</li>
                <li>No arbitrage detection</li>
              </ul>
            </div>
            ...
            <div style={{
              ...
              <ul style={{
                ...
                <li>Embedded form check</li>
                <li>No external form redirects</li>
                <li>Consistent UX validation</li>
                <li>Form action analysis</li>
              </ul>
            </div>
        ...
        <div className="responsive-section" style={{
          ...
          <p style={{
            ...
            Simple 4-step process to validate your landing page
          </p>
          ...
          <div className="responsive-workflow" style={{
            ...
            <div style={{
              ...
              <p style={{
                ...
                Paste your landing page URL that you want to validate
              </p>
            </div>
            ...
            <div style={{
              ...
              <p style={{
                ...
                Our AI scans your LP and checks all Google Ads requirements
              </p>
            </div>
            ...
            <div style={{
              ...
              <p style={{
                ...
                Receive score (0-100), grade (A-F), and detailed breakdown
              </p>
            </div>
            ...
            <div style={{
              ...
              <p style={{
                ...
                Follow recommendations to fix issues and improve compliance
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="responsive-grid-2" style={{
            ...
            <div className="result-card" style={{
              ...
              <p style={{
                ...
                Get a comprehensive score based on all Google Ads requirements
              </p>
            </div>
            ...
            <div className="result-card" style={{
              ...
              <p style={{
                ...
                Easy-to-understand grade from A (Excellent) to F (Fail)
              </p>
            </div>
            ...
            <div className="result-card" style={{
              ...
              <p style={{
                ...
                Detailed analysis for each requirement category
              </p>
            </div>
            ...
            <div className="result-card" style={{
              ...
              <p style={{
                ...
                Actionable steps to fix issues and improve compliance
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="responsive-section" style={{
          ...
          <p style={{
            ...
            Save time and avoid costly mistakes with your Google Ads campaigns
          </p>
          ...
          <div className="responsive-grid-4" style={{
            ...
            <div style={{
              ...
              <p style={{
                ...
                Catch issues before Google Ads reviews your landing page
              </p>
            </div>
            ...
            <div style={{
              ...
              <p style={{
                ...
                Advanced AI analyzes content quality and originality
              </p>
            </div>
            ...
            <div style={{
              ...
              <p style={{
                ...
                100% free tool to validate unlimited landing pages
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="responsive-section" style={{
          ...
          <p style={{
            ...
            Everything you need to know about the QC Scanner
          </p>
          ...
          <div className="responsive-faq" style={{
            ...
            <div style={{
              ...
              <h3 style={{
                ...
                What Google Ads requirements do you check?
              </h3>
              <p style={{
                fontSize: '14px',
                color: '#4b5563',
                ...
                We check domain ownership, redirect chains, content originality, form integration, footer with company info, and policy page links - all based on official Google Ads requirements.
              </p>
            </div>
            ...
            <div style={{
              ...
              <p style={{
                ...
                Most scans complete in 10-30 seconds depending on the landing page size and complexity. The AI analysis is done in real-time.
              </p>
            </div>
            ...
            <div style={{
              ...
              <p style={{
                ...
                Grade A (90-100) = Excellent, B (80-89) = Good, C (70-79) = Fair, D (60-69) = Poor, F (0-59) = Fail. Follow recommendations to improve your grade.
              </p>
            </div>
            ...
            <div style={{
              ...
              <p style={{
                ...
                We cache scan results for 24 hours to improve performance. You can delete your scan history anytime. Your landing page content is analyzed securely.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="responsive-cta-section" style={{
          ...
          <h2 className="responsive-cta-heading" style={{
            ...
            Ready to Validate Your Landing Page?
          </h2>
          <p className="cta-description-single-line" style={{
            ...
            Start scanning now and ensure your Google Ads campaigns run smoothly without compliance issues
          </p>
          <button
